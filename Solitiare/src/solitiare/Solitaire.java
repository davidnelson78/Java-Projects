...
public class Solitaire {
    ...
    // other components
    private static final JEditorPane gameTitle = new JEditorPane("text/html", "");
    private static final JButton showRulesButton = new JButton("Show Rules");
    private static final JButton newGameButton = new JButton("New Game");
    private static final JButton toggleTimerButton = new JButton("Pause Timer");
    private static final JTextField scoreBox = new JTextField();// displays the score
    ...
    private static class CardMovementManager extends MouseAdapter {
        ...
        private final CardStack transferStack = new CardStack(false);
    ...
    private static void playNewGame() {
        ...
        gameTitle.setText("<b>Klondike Solitaire</b> <br> SP2018 Individual Project");
